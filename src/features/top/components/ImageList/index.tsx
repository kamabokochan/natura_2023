...
export const ImageList = () => {
  return (
    <>
      <div className='m-3 mx-auto max-w-5xl'>
        <div className='flex h-60'>
          ...
          <div className='w-1/4 ml-3'>
            <Img
              src='https://natura.netlify.app/optimized_img/gallery/foods/food1.jpg'
              alt='image'
            />
          </div>
        </div>
        <div className='flex h-60 mt-3'>
          <div className='w-1/4'>
            <Img
              src='https://natura.netlify.app/optimized_img/gallery/foods/food7.jpg'
              alt='image'
            />
          </div>
